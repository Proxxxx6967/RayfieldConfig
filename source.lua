...
local prompt = useStudio and require(script.Parent.prompt) or loadWithTimeout('https://raw.githubusercontent.com/Proxxxx6967/RayfieldPrompt/refs/heads/main/prompt.lua')
